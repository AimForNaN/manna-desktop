...
<style lang="less">
    #bread {
        ...
        .modules {
            @apply cursor-pointer gap-5 grid grid-cols-1 lg:gap-8 lg:grid-cols-2 xl:grid-cols-3;

            .module {
                @apply duration-300 flex flex-col rounded text-lg transition lg:p-3 lg:h-24;
